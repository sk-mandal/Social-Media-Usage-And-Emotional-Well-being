# =========================================
# Deep Learning Model for Emotion Prediction
# =========================================
...
# =========================================
# STEP 7.1: Load Dataset (Robust Loading)
# =========================================
...
# Remove rows with missing target (train & val only)
...
# =========================================
# STEP 7.3: Encode Target Variable (FIXED)
# =========================================

label_encoder = LabelEncoder()

# Fit on train + validation to include all labels
label_encoder.fit(
...
# =========================================
# STEP 7.4: Feature Preprocessing (DL)
# =========================================
...
# Convert sparse to dense (required for ANN)
...
# =========================================
# STEP 7.5: Compute Class Weights (IMPORTANT)
# =========================================
...
# =========================================
# STEP 7.6: Build ANN Model (Improved)
# =========================================
...
# =========================================
# STEP 7.7: Train ANN with Class Weights
# =========================================
