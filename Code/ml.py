...
# =========================================
# STEP 3: Data Preprocessing & Feature Engineering (BULLETPROOF)
# =========================================
...
# -------------------------
# 2. Explicitly define feature columns (DO NOT infer)
# -------------------------
numeric_features = [
    "Age",
...
# -------------------------
# 3. Force numeric columns to numeric (coerce bad values)
# -------------------------
for df in [df_train, df_val, df_test]:
...
# =========================================
# STEP 4: Baseline ML Models (FINAL & FIXED)
# =========================================
...
# =========================================
# STEP 6: Hyperparameter Tuning (ML)
# =========================================
